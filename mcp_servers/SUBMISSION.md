...
| 2 | **Publicly available on GitHub** | Yes — <https://github.com/CiscoDevNet/fmc-automation-mcp> |
| 3 | Licensed under an [OSI-approved open source licence](https://opensource.org/licenses/alphabetical/) **or** the [Cisco Sample Code License](https://developer.cisco.com/site/license/cisco-sample-code-license/) | Yes — Apache-2.0, which is OSI-approved. See [LICENSE](../LICENSE) |
...
- **Apache-2.0 (what this project uses)** — OSI-approved, permissive, includes an
  express patent grant, no field-of-use restriction. Appropriate for a community
  project not owned by Cisco.
...
| `LICENSE` | Must be OSI-approved or the Cisco Sample Code License. This project uses Apache-2.0. |
...
```bash
gh repo edit CiscoDevNet/fmc-automation-mcp \
