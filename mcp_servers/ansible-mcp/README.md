...
cd fmc-automation-mcp/mcp_servers/ansible-mcp
```
...
ANSIBLE_PROJECT_DIR=/absolute/path/to/fmc-automation-mcp
...
[GitHub Issues](https://github.com/CiscoDevNet/fmc-automation-mcp/issues). Please use the
...
| I need... | Go to |
| --- | --- |
| Help with this server, a bug, or a feature idea | [GitHub Issues](https://github.com/CiscoDevNet/fmc-automation-mcp/issues/new/choose) |
...
vendored, or linked against, so no copyleft obligation attaches to this Apache-2.0-licensed
